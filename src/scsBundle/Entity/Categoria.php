 ...
 * @ORM\Entity(repositoryClass="scsBundle\Repository\CategoriaRepository")
 * @UniqueEntity("nombre", message="Existe una categoría registrada con ese nombre")
 */
class Categoria
{
    /**
    ...
    /**
     * @ORM\OneToMany(targetEntity="scsBundle\Entity\Trabajador", mappedBy="categoria", orphanRemoval=true)
     */
