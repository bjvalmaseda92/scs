        ...
        init: function () {
            ...
            $('#sample_1').dataTable({
                ...
                "oLanguage": {
                    ...
                    '</select> usuarios',
                    "sZeroRecords": "No hay usuarios para mostrar",
                    "oPaginate": {
                        "sPrevious": "Ant",
                        "sNext": "Sig"
                    },
                    "sSearch": "Buscar:",
                    "sInfo": "Mostrando usuarios desde el _START_ hasta el _END_ ( _TOTAL_ usuarios registrados)",
                    "sInfoFiltered": "(_MAX_ usuarios filtrados)",
                    "sInfoEmpty": "No hay usuarios para mostrar",
