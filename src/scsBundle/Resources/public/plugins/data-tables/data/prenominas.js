        ...
        init: function () {
            ...
            $('#sample_1').dataTable({
                ...
                "oLanguage": {
                    ...
                    '</select> prenóminas',
                    "sZeroRecords": "No hay prenóminas para mostrar",
                    "oPaginate": {
                        "sPrevious": "Ant",
                        "sNext": "Sig"
                    },
                    "sSearch": "Buscar:",
                    "sInfo": "Mostrando prenóminas desde el _START_ hasta el _END_ ( _TOTAL_ prenóminas registradas)",
                    "sInfoFiltered": "(_MAX_ prenóminas filtradas)",
                    "sInfoEmpty": "No hay prenóminas para mostrar",
