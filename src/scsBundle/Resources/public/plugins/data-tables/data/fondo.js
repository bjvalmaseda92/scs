        ...
        init: function () {
            ...
            $('#sample_1').dataTable({
                ...
                "oLanguage": {
                    ...
                    '</select>fondos',
                    "sZeroRecords": "No hay fondos para mostrar",
                    "oPaginate": {
                        "sPrevious": "Ant",
                        "sNext": "Sig"
                    },
                    "sSearch": "Buscar:",
                    "sInfo": "Mostrando fondos desde el _START_ hasta el _END_ ( _TOTAL_ fondos registrados)",
                    "sInfoFiltered": "(_MAX_ fondos filtrados)",
                    "sInfoEmpty": "No hay fondos para mostrar",
