        ...
        init: function () {
            ...
            $('#sample_1').dataTable({
                ...
                "oLanguage": {
                    ...
                    '</select> producciones',
                    "sZeroRecords": "No hay producciones para mostrar",
                    "oPaginate": {
                        "sPrevious": "Ant",
                        "sNext": "Sig"
                    },
                    "sSearch": "Buscar:",
                    "sInfo": "Mostrando producciones desde el _START_ hasta el _END_ ( _TOTAL_ producciones registradas)",
                    "sInfoFiltered": "(_MAX_ producciones filtradas)",
                    "sInfoEmpty": "No hay producciones para mostrar",
