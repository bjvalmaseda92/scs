        ...
        init: function () {
            ...
            $('#sample_1').dataTable({
                ...
                "oLanguage": {
                    ...
                    '</select> trabajadores',
                    "sZeroRecords": "No hay trabajadores para mostrar",
                    "oPaginate": {
                        "sPrevious": "Ant",
                        "sNext": "Sig"
                    },
                    "sSearch": "Buscar:",
                    "sInfo": "Mostrando trabajadores desde el _START_ hasta el _END_ ( _TOTAL_ trabajadores registrados)",
                    "sInfoFiltered": "(_MAX_ trabajadores filtrados)",
                    "sInfoEmpty": "No hay trabajadores para mostrar",
