        ...
        init: function () {
            ...
            $('#sample_1').dataTable({
                ...
                "oLanguage": {
                    ...
                    '</select> escalas',
                    "sZeroRecords": "No hay escalas para mostrar",
                    "oPaginate": {
                        "sPrevious": "Ant",
                        "sNext": "Sig"
                    },
                    "sSearch": "Buscar:",
                    "sInfo": "Mostrando escalas desde el _START_ hasta el _END_ ( _TOTAL_ escalas registradas)",
                    "sInfoFiltered": "(_MAX_ escalas filtradas)",
                    "sInfoEmpty": "No hay escalas para mostrar",
