        ...
        init: function () {
            ...
            $('#sample_1').dataTable({
                ...
                "oLanguage": {
                    ...
                    '</select> categorías',
                    "sZeroRecords": "No hay categorías para mostrar",
                    "oPaginate": {
                        "sPrevious": "Ant",
                        "sNext": "Sig"
                    },
                    "sSearch": "Buscar:",
                    "sInfo": "Mostrando categorías desde el _START_ hasta el _END_ ( _TOTAL_ categorías registradas)",
                    "sInfoFiltered": "(_MAX_ categorías filtradas)",
                    "sInfoEmpty": "No hay categorías para mostrar",
